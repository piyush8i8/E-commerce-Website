...
const Cart = () => {
  const { cartitems, setCartItems, removeFromCart, product_list, url, token, addToCart } = useContext(storecontext);
  ...
  const handleAddToCart = async (itemId) => {
    addToCart(itemId); // Use the addToCart function from context
  };

  const handleRemoveFromCart = async (itemId) => {
    removeFromCart(itemId); // Use the removeFromCart function from context
  };
